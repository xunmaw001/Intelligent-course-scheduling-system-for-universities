...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>学生选课列表</span></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xuankeriqi')">选课日期<i id="xuankeriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xuankeriqiCell  = document.createElement('td');

						  xuankeriqiCell.innerHTML = item.xuankeriqi;


			row.appendChild(xuankeriqiCell);
            ...
            crossBtn1.innerHTML = "成绩"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"kechengchengji\")");
		...
		function sh(){
			...
			httpJson("xueshengxuanke/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xueshengxuanke/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xueshengxuanke");
