...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="zhuanye" id="zhuanyeSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										班级
									</label>
	...
	<script>
		...
		function search(){
			...
			var zhuanyeIndex = document.getElementById("zhuanyeSelect").selectedIndex;
			var zhuanyeOptions = document.getElementById("zhuanyeSelect").options;
			var zhuanyeSelectedOption = zhuanyeOptions[zhuanyeIndex]
			if(zhuanyeSelectedOption.text != null && zhuanyeSelectedOption.text != ''){
				searchForm.zhuanye = "%" + zhuanyeSelectedOption.text + "%";
			}
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "选课"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"xueshengxuanke\")");
