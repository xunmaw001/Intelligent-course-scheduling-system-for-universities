...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('kaohechengji')">考核成绩<i id="kaohechengjiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var kaohechengjiCell  = document.createElement('td');

						 kaohechengjiCell.innerHTML = item.kaohechengji;


			row.appendChild(kaohechengjiCell);
